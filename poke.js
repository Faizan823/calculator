...
function fuseBothPoke() {
  ...
  document.getElementById("atk1").innerHTML =
    "ATK: " + Math.floor(atk1) + L4[1];
  document.getElementById("def1").innerHTML =
    "DEF: " + Math.floor(def1) + L4[2];
  ...
  document.getElementById("spe1").innerHTML =
    "SPEED: " + Math.floor(spe1) + L4[5];
  document.getElementById("bs1").innerHTML =
    "TOTAL: " + Math.floor(bs1) + L4[6];
  ...
  /*}*/
  document.getElementById("atk2").innerHTML =
    "ATK: " + Math.floor(atk2) + L5[1];
  document.getElementById("def2").innerHTML =
    "DEF: " + Math.floor(def2) + L5[2];
  ...
  document.getElementById("spe2").innerHTML =
    "SPEED: " + Math.floor(spe2) + L5[5];
  document.getElementById("bs2").innerHTML =
    "TOTAL: " + Math.floor(bs2) + L5[6];
  ...
  var hiddenAbilities2 = fusionHiddenAbilities(
    mon2abilities,
    mon1abilities,
    abilties2
  );
...
function showFusion(elementId, fusionId, elementFusionId) {
  fusionUrl =
    "https://raw.githubusercontent.com/rohitkesharwani9/autogen-fusion-sprites/master/Battlers/" +
    fusionId;
